        ...
        <div>
            <div className="navbar">
                ...
                <div className="grid">
                    ...
                    <div className={show ? "flex-container" : "flex-container show active"}>
                        ...
                        <Link to="/technology"><h1 className={props.number === 4 ? 'border-style' : ''}><span>03</span>Technology</h1></Link>
                    </div>
                </div>
            </div>
        </div>
